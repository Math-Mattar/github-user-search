  ...
  return (
    <section className="flex w-full justify-center rounded-sm bg-background-details px-4 py-5">
      <div className="flex w-1/3 flex-col items-center">
        <h5 className="text-account-title font-regular text-h5">Repos</h5>
      ...
      <div className="flex w-1/3 flex-col items-center">
        <h5 className="text-account-title font-regular text-h5">Followers</h5>
        <h3 className="text-account-statistics text-h3 font-bold">
          {followers}
        </h3>
      </div>
      ...
      <div className="flex w-1/3 flex-col items-center">
        <h5 className="text-account-title font-regular text-h5">Following</h5>
        <h3 className="text-account-statistics text-h3 font-bold">
          {following}
        </h3>
      </div>
